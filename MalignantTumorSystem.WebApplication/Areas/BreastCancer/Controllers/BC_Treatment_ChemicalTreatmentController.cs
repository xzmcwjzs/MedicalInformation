...
{
    public class BC_Treatment_ChemicalTreatmentController : BaseTopController
    {
        // GET: BreastCancer/BC_Treatment_ChemicalTreatment
        [Inject]
        ...
        [Inject]
        public IMT_BC_ChemicalTreatmentService mT_BC_ChemicalTreatmentService { get; set; }
        ...
        public ActionResult List()
        {
            ...
            var list = mT_BC_ChemicalTreatmentService.LoadSearchEntities(commonParam);
            totalCount = commonParam.TotalCount;
            int PageCount = Convert.ToInt32(Math.Ceiling((double)totalCount / pageSize));

            List<MT_BC_ChemicalTreatment> result = new List<MT_BC_ChemicalTreatment>();
            result.AddRange(list);
            PagerInfo pager = new PagerInfo();
            pager.PageIndex = pageIndex;
            pager.PageSize = pageSize;
            pager.TotalCount = totalCount;
            PagerQuery<PagerInfo, List<MT_BC_ChemicalTreatment>> query = new PagerQuery<PagerInfo, List<MT_BC_ChemicalTreatment>>(pager, result);
        ...
        //新增页
        public ActionResult ChemicalTreatment()
        {
            Comm_Platform_Worker workerModel = Session["worker"] as Comm_Platform_Worker;
        ...
        public ActionResult AddAndUpdate()
        {
            ...
            MT_BC_ChemicalTreatment entity = new MT_BC_ChemicalTreatment();
            ...
            //------------------------------------特有字段赋值-------------------------------------------------------
            entity.hl1y = Request["hl1y"];
            entity.hl1f = Request["hl1f"];
            entity.hl2y = Request["hl2y"];
            entity.hl2f = Request["hl2f"];
            entity.hl3y = Request["hl3y"];
            entity.hl3f = Request["hl3f"];
            ...
            if (string.IsNullOrEmpty(id))
            {
                if (mT_BC_ChemicalTreatmentService.AddEntity(entity))
                {
                    ...
                    ehr.item_type = Model.Enum.EHRAbstractTypeEnum.ChemicalTreatment.ToString();
            ...
            {
                if (mT_BC_ChemicalTreatmentService.UpdateEntity(entity))
                {
                    msg = "修改成功";
                }
                else
        ...
        public ActionResult ChemicalTreatmentShow()
        {
            Comm_Platform_Worker workerModel = Session["worker"] as Comm_Platform_Worker;
            ViewBag.real_name = CommonFunc.SafeGetStringFromObj(workerModel.real_name);
            ViewBag.worker = CommonFunc.SafeGetStringFromObj(workerModel.user_name);
        ...
        public ActionResult ChemicalTreatmentUpdate()
        {
            Comm_Platform_Worker workerModel = Session["worker"] as Comm_Platform_Worker;
            ViewBag.real_name = CommonFunc.SafeGetStringFromObj(workerModel.real_name);
            ViewBag.worker = CommonFunc.SafeGetStringFromObj(workerModel.user_name);
        ...
        public ActionResult Show()
        {
            ...
            if (id != "")
            {
                var result = mT_BC_ChemicalTreatmentService.LoadEntityAsNoTracking(t => t.id.Contains(id));
