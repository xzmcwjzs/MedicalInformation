...
{
    public class BC_Treatment_TCMTreatmentController : BaseTopController
    {
        // GET: BreastCancer/BC_Treatment_TCMTreatment
        [Inject]
        ...
        [Inject]
        public IMT_BC_TCMTreatmentService mT_BC_TCMTreatmentService { get; set; }
        #region 框架页 
        ...
        public ActionResult List()
        {
            ...
            var list = mT_BC_TCMTreatmentService.LoadSearchEntities(commonParam);
            totalCount = commonParam.TotalCount;
            int PageCount = Convert.ToInt32(Math.Ceiling((double)totalCount / pageSize));

            List<MT_BC_TCMTreatment> result = new List<MT_BC_TCMTreatment>();
            result.AddRange(list);
            PagerInfo pager = new PagerInfo();
            pager.PageIndex = pageIndex;
            pager.PageSize = pageSize;
            pager.TotalCount = totalCount;
            PagerQuery<PagerInfo, List<MT_BC_TCMTreatment>> query = new PagerQuery<PagerInfo, List<MT_BC_TCMTreatment>>(pager, result);
        ...
        public ActionResult AddAndUpdate()
        {
            ...
            MT_BC_TCMTreatment entity = new MT_BC_TCMTreatment();
            ...
            //------------------------------------特有字段赋值-------------------------------------------------------
            entity.zl = Request["zl"];
            entity.zl1jj = Request["zl1jj"];
            entity.zl2jj = Request["zl2jj"];
            entity.zl3jj = Request["zl3jj"];
            entity.zl4jj = Request["zl4jj"];
            entity.zl5jj = Request["zl5jj"];
            entity.zl6jj = Request["zl6jj"];
            entity.zl7jj = Request["zl7jj"];
            entity.zl8jj = Request["zl8jj"];
            entity.zl9jj = Request["zl9jj"];
            entity.zl10jj = Request["zl10jj"];
            entity.zl11jj = Request["zl11jj"];
            entity.zl12jj = Request["zl12jj"];
            entity.zl13jj = Request["zl13jj"];
            entity.wyy = Request["wyy"];
            ...
            if (string.IsNullOrEmpty(id))
            {
                if (mT_BC_TCMTreatmentService.AddEntity(entity))
                {
                    ...
                    ehr.item_type = Model.Enum.EHRAbstractTypeEnum.TCMTreatment.ToString();
            ...
            {
                if (mT_BC_TCMTreatmentService.UpdateEntity(entity))
                {
                    msg = "修改成功";
                }
                else
        ...
        public ActionResult TCMTreatmentShow()
        {
            Comm_Platform_Worker workerModel = Session["worker"] as Comm_Platform_Worker;
            ViewBag.real_name = CommonFunc.SafeGetStringFromObj(workerModel.real_name);
            ViewBag.worker = CommonFunc.SafeGetStringFromObj(workerModel.user_name);
        ...
        public ActionResult TCMTreatmentUpdate()
        {
            Comm_Platform_Worker workerModel = Session["worker"] as Comm_Platform_Worker;
            ViewBag.real_name = CommonFunc.SafeGetStringFromObj(workerModel.real_name);
            ViewBag.worker = CommonFunc.SafeGetStringFromObj(workerModel.user_name);
        ...
        public ActionResult Show()
        {
            ...
            if (id != "")
            {
                var result = mT_BC_TCMTreatmentService.LoadEntityAsNoTracking(t => t.id.Contains(id));
