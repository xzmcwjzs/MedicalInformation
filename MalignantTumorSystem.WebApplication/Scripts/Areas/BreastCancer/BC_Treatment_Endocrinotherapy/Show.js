$(function () {
    $.ajax({
        type:"post",
        dataType:"json",
        url: "/BreastCancer/BC_Treatment_Endocrinotherapy/Show",
        data:{id:id},
        success: function (data) { 
            ...
            $("#zl1q").val(data[0].zl1q);
            $("#zl1h").val(data[0].zl1h);
            $("#zl2q").val(data[0].zl2q);
            $("#zl2h").val(data[0].zl2h);
            $("#zl3q").val(data[0].zl3q);
            $("#zl3h").val(data[0].zl3h);
