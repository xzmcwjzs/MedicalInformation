$(function () {
    $.ajax({
        type: "post",
        dataType: "json",
        url: "/BreastCancer/BC_FollowupAndExamination_PE/ShowPE",
        data: { id: id},
        success: function (data) {
            ...
            if (data[0].individual_phone != "") {
                $("#phone").val(data[0].individual_phone);
            } else {
                $("#phone").val(data[0].family_phone);
            }

            if (data[0].tijianriqi != "") {
                $("#time").val(ConvertDate(data[0].tijianriqi));
            }
            $("#company").val(data[0].company);
            $("#t").val(data[0].ybzk_tiwen);
            $("#p").val(data[0].ybzk_mailv);
            $("#r").val(data[0].ybzk_huxipinglv);
            $("#ssy").val(data[0].ybzk_xueya_h);
            $("#szy").val(data[0].ybzk_xueya_l);
            $("#height").val(data[0].ybzk_shenggao);
            $("#weight").val(data[0].ybzk_shenggao);
            $("#bmi").val(data[0].ybzk_tizhizhishu);
            $("#w").val(data[0].ybzk_yaowei);
            $("#h").val(data[0].ybzk_tunwei);
            $("#w_h").val(data[0].ybzk_yaotunweibi);
