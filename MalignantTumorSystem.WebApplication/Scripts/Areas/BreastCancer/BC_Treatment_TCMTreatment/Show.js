$(function () {
    $.ajax({
        type:"post",
        dataType:"json",
        url: "/BreastCancer/BC_Treatment_TCMTreatment/Show",
        data:{id:id},
        success: function (data) { 
            ...
            if (data[0].wyy != "" && data[0].wyy != null) {
                var strs = new Array();
                strs = data[0].wyy.split(',');
                for (var i = 0; i < strs.length; i++) {
                    $("input:checkbox[name='wyy'][value=" + strs[i] + "]").attr("checked", true);
                }
            }

            $("#zl1jj").val(data[0].zl1jj);
            $("#zl2jj").val(data[0].zl2jj);
            $("#zl3jj").val(data[0].zl3jj);
            $("#zl4jj").val(data[0].zl4jj);
            $("#zl5jj").val(data[0].zl5jj);
            $("#zl6jj").val(data[0].zl6jj);
            $("#zl7jj").val(data[0].zl7jj);
            $("#zl8jj").val(data[0].zl8jj);
            $("#zl9jj").val(data[0].zl9jj);
            $("#zl10jj").val(data[0].zl10jj);
            $("#zl11jj").val(data[0].zl11jj);
            $("#zl12jj").val(data[0].zl12jj);
            $("#zl13jj").val(data[0].zl13jj);
