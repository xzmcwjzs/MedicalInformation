...
{
    public partial class MT_BC_QOLService : BaseService<MT_BC_QOL>, IMT_BC_QOLService
    {
        public IQueryable<MT_BC_QOL> LoadSearchEntities(Model.SearchParam.CommonParam parms)
        {
